...
const Footer = (props: Props) => {
  return (
    <>
      ...
      <footer className="footer flex justify-between p-10 text-black lg:w-[80%]">
        <nav>
        ...
        <nav>
          ...
          <a className="link-hover link text-black">About us</a>
          <a className="link-hover link text-base-content text-black">
            Size Guide
          </a>
          <a className="link-hover link text-base-content text-black">Career</a>
          <a className="link-hover link text-base-content text-black">
            Contact us
          </a>
          <a className="link-hover link text-base-content text-black">
